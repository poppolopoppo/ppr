...
export namespace pP {
    ...
    using InputModifierEvent = std23::move_only_function<void(TimeSpan dt, InputValue &value)>;

    using InputTriggerEvent = std23::move_only_function<void(const InputActionEvent &event, const InputKey &trigger)>;
