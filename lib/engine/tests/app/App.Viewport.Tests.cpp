...
namespace pP::tests {
    const UnitTest viewport = UnitTest::Named("viewport") / [](UnitTest::IRun &_) -> void {
        _.recurse({
            ...
            detail::ViewportTypes::camera_keeps_prior_state_on_zero_viewport,
            detail::ServiceStores::child_store_shadows_parent,
            detail::ServiceStores::child_erase_keeps_parent_visible,
            detail::ViewportGeometry::layout_variant_covers_all_alternatives,
            detail::ViewportGeometry::screen_client_transforms_are_inverse,
            detail::ViewportGeometry::normalized_client_rect_round_trips,
            detail::ViewportGeometry::zero_window_propagates_empty_client,
            detail::ViewportGeometry::window_viewport_tracks_shared_window,
            detail::RectContains::point_truth_table_int,
            detail::RectContains::point_truth_table_float,
            detail::RectContains::rect_truth_table,
            detail::RectContains::empty_and_inverted_reject,
            detail::RectNormalize::normalize_maps_corners_and_center,
            detail::RectNormalize::normalize_denormalize_round_trip,
        });
        if constexpr (PPR_ENABLE_ASSERTIONS) {
            _.recurse({
                detail::RectNormalize::normalize_zero_extent_fails,
            });
        }
    };
