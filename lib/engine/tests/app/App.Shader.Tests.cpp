...
float4 fragmentMain(VSOutput input) : SV_Target {
    return input.color * g_constants.g_intensity;
        ...
        PPR_UNIT_TEST(set_target_format_lifecycle, UnitTest::expect_crash) {
            ...
            // Not initialized yet â€” target format must fail with uninitialized
...
namespace pP::tests {
    const UnitTest shader = UnitTest::Named("shader") / [](UnitTest::IRun &_) -> void {
        _.recurse({
            ...
            detail::ShaderErrC::errc_ok_not_error,
            detail::ShaderErrC::errc_make_error_code_from_result,
            detail::ShaderErrC::errc_result_convenience,
            detail::ShaderErrC::errc_error_condition_mapping,
            detail::RhiErrC::rhi_error_category_name,
            detail::RhiErrC::rhi_make_error_code,
            detail::RhiErrC::rhi_error_condition_mapping,
            detail::ModHandle::diagnose_default_construct,
            detail::ModHandle::module_handle_default,
            detail::ShaderComp::compile_simple_triangle_shader,
            detail::ShaderComp::compile_invalid_shader_recovery,
            detail::ShaderComp::shader_parameter_reflection,
            detail::ShaderComp::set_target_format_lifecycle,
            detail::ShaderComp::shutdown_before_init_ok,
            detail::ShaderComp::init_shutdown_shutdown_ok,
            detail::ShaderComp::init_init_ok,
            detail::ShaderComp::load_failure_recovery,
            detail::RhiLifecycle::shutdown_before_init_ok,
