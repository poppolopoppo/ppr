...
namespace pP::tests {
    const UnitTest player_graph = UnitTest::Named("player_graph") / [](UnitTest::IRun &_) -> void {
        _.recurse({
            ...
            detail::get_player_by_id,
            detail::get_nonexistent_player_returns_null,
            detail::find_player_for_device,
            detail::find_nonexistent_device_returns_nullopt,
            detail::enumerate_players,
            detail::remove_player,
            detail::remove_nonexistent_player_fails,
            detail::clear_removes_all_players,
            detail::graph_get_or_create_keyboard_is_idempotent,
            detail::when_player_added_callback,
            detail::when_player_removed_callback,
