...
export namespace pP::tests {
    ...
    PPR_UNIT_TEST (render_view){
        _.recurse({
            RendererBoundary::color_attachment_ops_have_sane_defaults,
            RendererBoundary::draw_submission_carries_camera_free_raster_state,
            RendererBoundary::triangle_frame_constants_match_hlsl_layout,
            RendererBoundary::perspective_uses_d3d_depth_zero_to_one,
            RendererBoundary::ortho_uses_d3d_convention_without_y_flip,
        });
