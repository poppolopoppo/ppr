...
export module engine.tests.core:math;
...
export namespace pP::tests {
    ...
    PPR_UNIT_TEST(math) {
        _.recurse({
            Math::scalar_rounding_to_int,
            Math::scalar_rounding_to_uint,
            Math::float2_rounding_to_int,
            Math::float3_rounding_to_uint,
            Math::float4_rounding,
            Math::double_rounding_fallbacks,
            Math::to_float_from_integral_vectors,
            Math::generic_vector_rounding_fallback,
        });
    };
}
