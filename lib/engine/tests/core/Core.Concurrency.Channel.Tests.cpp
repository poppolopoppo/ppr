...
namespace pP::tests::detail {
    namespace Raw_channel {
        ...
        PPR_UNIT_TEST (ring_buffer_wrap_around) {
            ...
            // Read and verify first batch â€” frees space at the front
            for (std::size_t i = 0; i < batch_size; ++i) {
                auto hdr = chan.consumerAcquire(RawChannel::peek_without_blocking);
                PPR_TEST_ASSERT(hdr.has_value());
            ...
            // Write second batch â€” wraps around in the ring buffer
            for (std::size_t i = 0; i < batch_size; ++i) {
                auto hdr = chan.producerReserve(payload_size);
                PPR_TEST_ASSERT(hdr.has_value());
        ...
        PPR_UNIT_TEST (close_idempotent) {
            ...
            PPR_TEST_ASSERT(close2 == RawChannel::error_closed);
            PPR_TEST_ASSERT(chan.isClosedOrClosing());
        };
        ...
        PPR_UNIT_TEST (select_close) {
            ...
            PPR_TEST_ASSERT(!chan_a.close());
            PPR_TEST_ASSERT(!chan_b.close());
        ...
        PPR_UNIT_TEST (select_notify_before_subscribe) {
            ...
            // Signal subscribes â€” should detect the already-fired PulseEvent
            // via subscribeEvent â†’ emitEvent â†’ notify path
            auto signal = select(chan_a, chan_b);
    ...
    namespace Typed_channel {
        ...
        PPR_UNIT_TEST (send_and_receive_int) {
            ...
            PPR_TEST_ASSERT(!chan.emplace(42));
        ...
        PPR_UNIT_TEST (send_receive_string) {
            ...
            PPR_TEST_ASSERT(!chan.emplace(std::move(msg)));
        ...
        PPR_UNIT_TEST (close_propagation) {
            ...
            PPR_TEST_ASSERT(bool(chan.send(2)));
        };
        ...
        PPR_UNIT_TEST (channel_destructor_drains_non_trivial) {
            details::TrackedDestruction::count = 0u;
            {
                auto chan = pP::Channel<details::TrackedDestruction>(std::in_place_t{}, 8u);
                PPR_TEST_ASSERT(!chan.emplace(42));
                PPR_TEST_ASSERT(!chan.emplace(99));
                const auto r1 = chan.receive();
        ...
        PPR_UNIT_TEST (range_iteration_blocking) {
            ...
            std::jthread producer([&chan] {
                for (int i = 0; i < 5; ++i) {
                    PPR_TEST_ASSERT(!chan.emplace(i));
                }
                PPR_TEST_ASSERT(!chan.close());
            });
        ...
        PPR_UNIT_TEST (range_iteration_non_blocking) {
            ...
            PPR_TEST_ASSERT(!chan.emplace(1));
            PPR_TEST_ASSERT(!chan.emplace(2));
            PPR_TEST_ASSERT(!chan.emplace(3));
            PPR_TEST_ASSERT(!chan.close());
...
namespace pP::tests {
    extern const UnitTest raw_channel = UnitTest::Named("raw_channel") / [](UnitTest::IRun &_) -> void {
        _.recurse({
            ...
            detail::Raw_channel::multiple_messages_sequence,
            detail::Raw_channel::ring_buffer_wrap_around,
            detail::Raw_channel::backpressure_drop_if_full,
            detail::Raw_channel::backpressure_yield_if_full,
            detail::Raw_channel::backpressure_wait_if_full,
            detail::Raw_channel::discard_record,
            detail::Raw_channel::flush_roundtrip,
            detail::Raw_channel::peek_without_blocking_empty,
            detail::Raw_channel::peek_without_blocking_with_data,
            detail::Raw_channel::close_idempotent,
            detail::Raw_channel::close_record_consumed,
            detail::Raw_channel::record_header_accessors,
            detail::Raw_channel::zero_size_record,
            detail::Raw_channel::consumer_blocks_until_data,
            detail::Raw_channel::concurrent_spsc,
            detail::Raw_channel::concurrent_mpsc,
            detail::Raw_channel::concurrent_mpmc,
            detail::Raw_channel::concurrent_close_wakeup,
            detail::Raw_channel::select_one,
            detail::Raw_channel::select_multiple,
            detail::Raw_channel::select_reset_rearms_pending_commit,
            detail::Raw_channel::select_close,
            detail::Raw_channel::select_loop,
            detail::Raw_channel::select_same_channel_two_messages,
            detail::Raw_channel::select_notify_before_subscribe,
            detail::Raw_channel::select_all_channels_ready,
            detail::Raw_channel::select_all_closed_range_for,
            detail::Raw_channel::select_three_channels_mixed,
            detail::Raw_channel::select_close_wakes_waiting_thread,
            detail::Raw_channel::select_concurrent_wakeup_and_drain,
    ...
    extern const UnitTest typed_channel = UnitTest::Named("typed_channel") / [](UnitTest::IRun &_) -> void {
        _.recurse({
            ...
            detail::Typed_channel::peek_non_blocking,
            detail::Typed_channel::send_receive_string,
            detail::Typed_channel::operator_stream_send,
            detail::Typed_channel::operator_stream_receive,
            detail::Typed_channel::in_place_construction,
            detail::Typed_channel::close_propagation,
            detail::Typed_channel::backpressure_drop,
            detail::Typed_channel::destructor_called_on_consume,
            detail::Typed_channel::concurrent_channel,
            detail::Typed_channel::operator_receive_on_closed,
            detail::Typed_channel::operator_receive_empty,
            detail::Typed_channel::shared_ptr_construction,
            detail::Typed_channel::flush,
            detail::Typed_channel::auto_close_in_destructor,
            detail::Typed_channel::channel_destructor_drains_non_trivial,
            detail::Typed_channel::range_iteration_blocking,
