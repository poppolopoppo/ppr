...
namespace pP::tests {
    const UnitTest value = UnitTest::Named("value") / [](UnitTest::IRun &_) -> void {
        _.recurse({
            ...
            detail::Opaque::Value::decl_dict,
            detail::Opaque::Value::decl_delegate,
            detail::Opaque::Value::decl_formatter,
            detail::Opaque::Value::decl_as_nullptr,
            detail::Opaque::Value::format_scalar,
            detail::Opaque::Value::format_array,
            detail::Opaque::Value::format_object,
            detail::Opaque::Value::format_delegate,
    ...
    const UnitTest block = UnitTest::Named("block") / [](UnitTest::IRun &_) -> void {
        _.recurse({
            ...
            detail::Opaque::Block::builder_strings,
            detail::Opaque::Block::builder_array,
            detail::Opaque::Block::builder_dict,
            detail::Opaque::Block::builder_formatter,
            detail::Opaque::Block::builder_delegate,
            detail::Opaque::Block::format_value_scalars,
            detail::Opaque::Block::format_block,
            detail::Opaque::Block::format_complex,
            detail::Opaque::Block::constructor,
