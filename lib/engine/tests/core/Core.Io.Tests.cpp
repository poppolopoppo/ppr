...
namespace pP::tests {
    ...
    extern const UnitTest request = UnitTest::Named("request") / [](UnitTest::IRun &_) -> void {
        _.recurse({
            ...
            detail::Io::Request::poll_idle_returns_zero,
            detail::Io::Request::read_completes,
            detail::Io::Request::reset_and_reuse,
            detail::Io::Request::select_with_timer,
            detail::Io::Request::cancel_inflight,
            detail::Io::Request::cancel_idempotent,
            detail::Io::Request::cancel_i_event,
