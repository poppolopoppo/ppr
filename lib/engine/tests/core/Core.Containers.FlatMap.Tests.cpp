...
namespace pP::tests {
    extern const UnitTest flat_map = UnitTest::Named("flat_map") / [](UnitTest::IRun &_) -> void {
        _.recurse({
            ...
            detail::Flat_map::find,
            detail::Flat_map::duplicate,
            detail::Flat_map::erase,
            detail::Flat_map::clear,
            detail::Flat_map::iteration_sorted,
            detail::Flat_map::lower_bound,
            detail::Flat_map::upper_bound,
            detail::Flat_map::contains,
            detail::Flat_map::at,
            detail::Flat_map::operator_sq,
            detail::Flat_map::const_find,
            detail::Flat_map::const_at,
            detail::Flat_map::const_contains,
            detail::Flat_map::copy,
            detail::Flat_map::move,
            detail::Flat_map::growth,
            detail::Flat_map::range_insert,
            detail::Flat_map::range_insert_duplicate,
            detail::Flat_map::range_insert_empty,
