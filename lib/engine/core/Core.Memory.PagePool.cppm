...
namespace pP::mem {
    ...
    export class PagePool {
            ...
            void deallocateRawFallback_(const void *const ptr, const std::size_t bytes);

        public:
            PagePool(const std::size_t page_size, const std::size_t num_reserved_pages);
            ~PagePool();
            ...
            void deallocateRaw(const void *const ptr, const std::size_t bytes,
                               const std::align_val_t alignment = std::align_val_t{hal::page_size});
